<template>
  <div>
    <p class="prose p text-global-foreground-accent">
      From the English language
      <a href="https://en.wikipedia.org/wiki/Table_of_contents" target="_blank">Wikipedia entry</a>
      about the topic.
    </p>

    <UiResponsiveSidebarLayout v-model:drawer-visible="showTocDrawer">
      <template #sidebar>
        <div class="prose">
      ...
      <template #content="{ sidebarState }">
        <div ref="originalContent" class="prose">
          <p>
...
<script setup lang="ts">
  ...
  import UiResponsiveSidebarLayout from '#resee-ux/components/ResponsiveSidebarLayout.vue';
